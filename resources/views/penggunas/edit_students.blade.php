...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('penggunas.update_students', $penggunas->idPengguna) }}" method="POST" class="no-select">
        @csrf
        @method('PUT')
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kelas" id="kelas" value="{{ $penggunas->kelas }}" class="border border-gray-300 rounded w-full px-3 py-2">
        </div>
        <div class="mb-4">
            <label for="angkatan" class="block text-gray-700">Generation</label>
            <input type="text" name="angkatan" id="angkatan" value="{{ $penggunas->angkatan }}" class="border border-gray-300 rounded w-full px-3 py-2">
        </div>
        <div class="mb-4">
            <label for="nohp" class="block text-gray-700">Call Number</label>
            <input type="text" name="nohp" id="nohp" value="{{ $penggunas->nohp }}" class="border border-gray-300 rounded w-full px-3 py-2">
        </div>
        <div class="mb-4">
        ...
        <button href="{{ route('penggunas.index_students') }}" class="bg-slate-700 text-white px-4 py-2 rounded-md">Cancel</button>
