...
<div class="mx-4 my-8">
    ...
    <form action="{{ route('penggunas.store_lecturers') }}" method="POST" class="no-select">
        @csrf
        <div class="mb-4">
        ...
        <button type="submit" class="bg-slate-700 hover:bg-opacity-90 text-white px-4 py-2 rounded">Add Lecturer</button>
    </form>
</div>
@endsection